...
### Bonkcoin DNS Seeders

The settings.conf has already been setup for you.

To run a DNS seeder for the Bonkcoin **mainnet**, build source from the `main-node-seeder` branch.

To run a DNS seeder for the Bonkcoin **testnet**, build source from the `test-node-seeder` branch.
### v1.1.0
